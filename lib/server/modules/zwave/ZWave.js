...
var ZWave = function () {
  ...
  _createClass(ZWave, [{
    ...
    value: function getInfo() {
      return new _sdk.Info(this.getId(), 'Zwave', 'ZWave support', new _sdk.Configuration([new _sdk.ConfigurationField('device', '', 'usb', 'USB dongle')]));
    }
  }, {
    key: 'onStart',
      ...
      if (deviceField != null) {
        ...
        this.zwave.on('node ready', function (nodeid, nodeinfo) {
          ...
          switch (nodeinfo.producttype) {
            case '0x0302':
              device = new _sdk.Cover(nodeid, nodeinfo.product);
              break;
            default:
    ...
    value: function onComponentChange(component) {
      ...
      if (component instanceof _sdk.Cover) {
        try {
