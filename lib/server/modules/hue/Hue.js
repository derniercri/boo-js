...
var Hue = function () {
  ...
  _createClass(Hue, [{
    ...
    value: function getInfo() {
      return new _Info2.default(this.getId(), "Hue", "Philips HUE module", new _Configuration.Configuration([new _Configuration.ConfigurationField('address', '', 'url', 'Address of the Hue controller'), new _Configuration.ConfigurationField('user', '', 'string', 'User registered on the Hue controller')]));
    }
  }, {
    key: 'onStart',
    ...
    value: function onComponentChange(component) {
      if (component instanceof _Component.Light) {
      ...
      } else if (component instanceof _Component.ColorLight) {}
    }
  }, {
    key: 'update',
