...
var Component = exports.Component = function () {
  function Component(identifier, label) {
    ...
    this.values = (_values = {
      ...
      green: undefined,
      sunset: undefined
    }, _defineProperty(_values, 'sunset', undefined), _defineProperty(_values, 'sunrise', undefined), _defineProperty(_values, 'temp', undefined), _defineProperty(_values, 'code', undefined), _defineProperty(_values, 'position', undefined), _values);
  }
...
var Light = exports.Light = function (_Component2) {
  ...
  function Light(identifier, label) {
    ...
    _this2.values.on = null;
    _this2.values.brightness = null;
    return _this2;
  }
...
var Weather = exports.Weather = function (_Component4) {
  ...
  _createClass(Weather, [{
    key: 'set',
    value: function set(sunset, sunrise, temp, code) {
